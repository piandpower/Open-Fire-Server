...
from framework.world import WorldGenerator, Strongpoint
...
for strongpoint in created_strongpoints:
    nodes.append(Strongpoint(strongpoint.id, Vector(strongpoint.location_x, strongpoint.location_y), strongpoint.level))
